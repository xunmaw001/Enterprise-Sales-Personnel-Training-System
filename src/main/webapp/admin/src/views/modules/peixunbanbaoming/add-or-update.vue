      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="培训班编号" prop="peixunbanbianhao">
          <el-input v-model="ruleForm.peixunbanbianhao" 
              placeholder="培训班编号" clearable  :readonly="ro.peixunbanbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训班编号" prop="peixunbanbianhao">
              <el-input v-model="ruleForm.peixunbanbianhao" 
        ...
        <el-form-item class="input" v-if="type!='info'"  label="培训类型" prop="peixunleixing">
          <el-input v-model="ruleForm.peixunleixing" 
              placeholder="培训类型" clearable  :readonly="ro.peixunleixing"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `peixunbanbaoming/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.peixunbanbaomingCrossAddOrUpdateFlag = false;
                  this.parent.search();
