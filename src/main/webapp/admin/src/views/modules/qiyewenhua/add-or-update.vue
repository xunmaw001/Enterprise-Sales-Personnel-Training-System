              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhaiyao" label="摘要" prop="zhaiyao">
                    <span>{{ruleForm.zhaiyao}}</span>
                                                            ...
                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="企业历史" prop="qiyelishi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="企业历史"
                  v-model="ruleForm.qiyelishi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiyelishi" label="企业历史" prop="qiyelishi">
                    <span>{{ruleForm.qiyelishi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="关于我们" prop="guanyuwomen">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="关于我们"
                  v-model="ruleForm.guanyuwomen" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guanyuwomen" label="关于我们" prop="guanyuwomen">
                    <span>{{ruleForm.guanyuwomen}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.neirong = true;
            continue;
	            	            ...
	            	            if(o=='qiyelishi'){
            this.ruleForm.qiyelishi = obj[o];
	    this.ro.qiyelishi = true;
            continue;
          }
	            	            if(o=='guanyuwomen'){
            this.ruleForm.guanyuwomen = obj[o];
	    this.ro.guanyuwomen = true;
            continue;
          }
	            	            if(o=='tupian'){
