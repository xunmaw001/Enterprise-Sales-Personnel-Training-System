<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="培训班编号" prop="peixunbanbianhao">
            <el-input v-model="ruleForm.peixunbanbianhao" 
                placeholder="培训班编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.peixunbanbianhao" label="培训班编号" prop="peixunbanbianhao">
              <el-input v-model="ruleForm.peixunbanbianhao" 
                placeholder="培训班编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="培训班名称" prop="peixunbanmingcheng">
          <el-input v-model="ruleForm.peixunbanmingcheng" 
              placeholder="培训班名称" clearable  :readonly="ro.peixunbanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训班名称" prop="peixunbanmingcheng">
              <el-input v-model="ruleForm.peixunbanmingcheng" 
                placeholder="培训班名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="培训类型" prop="peixunleixing">
          <el-select v-model="ruleForm.peixunleixing" placeholder="请选择培训类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="培训类型" prop="peixunleixing">
          ...
          <el-form-item class="input" label="上课地点" prop="shangkedidian">
              <el-input v-model="ruleForm.shangkedidian" 
                placeholder="上课地点" readonly></el-input>
                                                                                                                                        ...
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="讲师介绍" prop="jiangshijieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="讲师介绍"
                  v-model="ruleForm.jiangshijieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiangshijieshao" label="讲师介绍" prop="jiangshijieshao">
                    <span>{{ruleForm.jiangshijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	peixunbanbianhao : false,
	peixunbanmingcheng : false,
	peixunleixing : false,
	tupian : false,
	jiage : false,
	keshi : false,
	...
	shangkedidian : false,
	jiangshijieshao : false,
	kechengjieshao : false,
	thumbsupnum : false,
	crazilynum : false,
      },
            ruleForm: {
                        peixunbanbianhao: this.getUUID(),
                        	        peixunbanmingcheng: '',
	                        	        peixunleixing: '',
	                        	        tupian: '',
	                        	        jiage: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='peixunbanbianhao'){
            this.ruleForm.peixunbanbianhao = obj[o];
	    this.ro.peixunbanbianhao = true;
            continue;
          }
	            	            if(o=='peixunbanmingcheng'){
            this.ruleForm.peixunbanmingcheng = obj[o];
	    this.ro.peixunbanmingcheng = true;
            continue;
          }
	            	            if(o=='peixunleixing'){
	    ...
	    this.ro.shangkedidian = true;
            continue;
	            	            ...
	            	            if(o=='jiangshijieshao'){
            this.ruleForm.jiangshijieshao = obj[o];
	    this.ro.jiangshijieshao = true;
            continue;
          }
	            	            if(o=='kechengjieshao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `peixunban/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.peixunbanCrossAddOrUpdateFlag = false;
                  this.parent.search();
